  ...
  return (
    <div className={cn("sifix-card", size === "lg" && "p-4")}>
      <div className="flex items-center justify-between mb-2">
        <span className="text-xs text-sifix-muted uppercase tracking-wider">Risk Score</span>
        <span
          className={cn(
      ...
      <div className="flex items-end gap-2">
        ...
        <span className="text-sifix-muted text-xs mb-1">/100</span>
      </div>
      {/* Progress bar */}
      <div className="mt-2 h-1.5 bg-sifix-surface rounded-full overflow-hidden">
        <div
