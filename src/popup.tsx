...
function Popup() {
  ...
  return (
    <div className="popup-container">
      {/* Top glow */}
      <div className={`absolute inset-x-0 top-0 h-48 ${glowClass} pointer-events-none`} style={{ opacity: 0.3 }} />

      <div className="relative z-10 flex flex-col items-center flex-1 px-6 pt-10 pb-4">
        {/* Shield */}
        ...
        {pageStatus.domain && (
          <p className="text-[11px] text-charcoal mt-1 font-mono">{pageStatus.domain}</p>
        )}
        {pageStatus.reason && (
          <p className="text-[10px] text-sifix-text-50 mt-0.5 text-center leading-relaxed max-w-[260px]">{pageStatus.reason}</p>
        )}
        ...
        <div className="mt-6 w-full max-w-[260px]">
          ...
          >
            <div className="flex items-center gap-2.5">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={protecting ? "#3b9eff" : "rgba(252,253,255,0.4)"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>
              </svg>
        ...
        <div className="mt-5 flex items-center gap-2">
          ...
          <span className="text-[11px] text-sifix-text-50 font-mono">
        ...
        <a
          ...
          className="mt-3 text-[11px] text-accent-blue hover:text-white transition-colors font-medium flex items-center gap-1"
        >
          Open Dashboard
        ...
        <button
          ...
          className="mt-auto text-[10px] text-sifix-text-30 hover:text-accent-red transition-colors pb-1"
        >
          Disconnect
        </button>
      </div>
